...
class Requisition(models.Model):
    ...
    payment = models.CharField(blank=True, null=True, max_length=20, verbose_name=u"支付方式")
    ...
    unit = models.IntegerField(choices=unit, blank=True, null=True, verbose_name=u'金额单位', default=1)
    ...
    end_time = models.DateField(null=True, blank=True, verbose_name=u'资产截止日期')
    comment = models.TextField(blank=True, null=True, max_length=100, verbose_name=u'备注')
